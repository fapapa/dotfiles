...
#############################################################
#
# Personal, non-default config starts here
#
#############################################################
...
let posh_theme = $'~/.oh-my-posh-custom.toml'
$env.PROMPT_COMMAND = { || oh-my-posh prompt print primary --config $'($posh_theme)' }
$env.PROMPT_MULTILINE_INDICATOR = { || oh-my-posh prompt print secondary --config $'($posh_theme)' }
